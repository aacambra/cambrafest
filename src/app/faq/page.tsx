      ...
      <main className="grid grid-cols-1 gap-1 h-[81vh] pt-4 px-6 overflow-y-auto no-scrollbar">
        ...
        <div className="py-4">
          ...
          <p className="text-center text-[#FDFAFA] py-2">
            O evento irá ocorrer nos dias 11 e 12 de agosto de 2023. Horário de
            abertura: 19h30. Horário limite de acesso ao evento: 3h.
          </p>
        </div>
        <div className="py-4">
          <h4 className="text-center text-2xl font-semibold text-[#EF8F1E]">
          ...
          <p className="text-center text-[#FDFAFA] py-2">
            ...
            localizada na sub-região da Área Metropolitana do Porto, pertencendo
            à região do Norte e ao distrito de Aveiro. Este evento imperdível
            acontece no Complexo Desportivo das Dairas, proporcionando um
            ambiente perfeito para desfrutar de música, entretenimento e
            diversão.
          </p>
        </div>
        <div className="py-4">
          ...
          <p className="text-center text-[#FDFAFA] py-2">
            Se desejas obter informações precisas sobre as coordenadas exatas do
            evento, convido-te a consultar o seguinte link: 👉{" "}
        ...
        <div className="py-4">
          ...
          <p className="text-center text-[#FDFAFA] py-2">
            Podes adquirir o teu bilhete na bilheteira online BOL! Compra agora
            mesmo através deste link 👉{" "}
            <span className="text-[#039B7D] font-semibold text-lg">
        ...
        <div className="py-4">
          ...
          <p className="text-center text-[#FDFAFA] py-2">
            O acesso ao recinto é exclusivamente permitido através da utilização
            de pulseira. Para tal, é necessário validar o bilhete e colocar a
            pulseira na entrada. Esta medida aplica-se tanto aos passes gerais
            como aos bilhetes diários. A pulseira é pessoal e intransmissível,
            não sendo permitido guardá-la para posterior colocação.
          </p>
        </div>
        <div className="py-4">
          <h4 className="text-center text-2xl font-semibold text-[#EF8F1E]">
        ...
        <div className="py-4">
          ...
          <p className="text-center text-[#FDFAFA] py-2">
            ...
            pagando o valor integral do bilhete e também deverão ir acompanhados
        ...
        <div className="py-4">
          ...
          <p className="text-center text-[#FDFAFA] py-2">
            ...
            solução perfeita para ti. Boa música e a natureza são sempre uma boa
            combinação quando queremos descomprimir entre amigos ou em família.
            Mesmo ao lado do recinto, existe uma área especialmente reservada
            para acampar. Para obteres mais informações acerca da localização,
            convido-te a aceder ao seguinte link: 👉{" "}
            <span className="text-[#039B7D] font-semibold text-lg">
